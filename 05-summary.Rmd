...
Output the results of the analysis to an Excel workbook with seperate sheets for de novo, homozygous, unphased compound hetorygous and phased compound heterozygous variants. For compound heterozygous variants, highlight variants in the same transcript with a single colour for ease of viewing.
...
saveWorkbook(wb, "pedigree_results_08_07_23.xlsx", overwrite = TRUE)
```
